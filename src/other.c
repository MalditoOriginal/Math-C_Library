...
START_TEST(pow_tests) {
  ...
  ck_assert_ldouble_eq(pow(13.21313, 2.5), s21_pow(13.21313, 2.5));
...
START_TEST(exp_tests) {
  ...
  ck_assert_ldouble_eq(exp(1.656768), s21_exp(1.656768));
...
START_TEST(atan_tests) {
  ...
  ck_assert_ldouble_eq(atan(13.54), s21_atan(13.54));
